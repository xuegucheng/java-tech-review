...
- [static 与类初始化](../深度解析/static与类初始化.md)
- [final 与常量](../深度解析/final与常量设计.md)
- [对象创建与不可变设计](../深度解析/对象创建与不可变设计.md)

## Runnable Example

- [ClassInitializationDemo.java](../../示例代码/src/main/java/com/xuegucheng/javatechreview/ClassInitializationDemo.java)
- [对应测试](../../示例代码/src/test/java/com/xuegucheng/javatechreview/ClassInitializationDemoTest.java)
