...
本页只维护对象相等性的语言契约。HashMap 如何消费这个契约、HashSet 如何复用 HashMap，见 [Collections 的 Hash 集合复习](../../02-集合框架/面试速记/HashMap与Hash集合.md)。

## Deep Dive

- [equals 与 hashCode 契约](../深度解析/equals与hashCode契约.md)
- [Object 方法与工具](../深度解析/toString与对象工具方法.md)
