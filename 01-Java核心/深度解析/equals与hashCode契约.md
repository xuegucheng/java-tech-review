...
> **Authoritative source：Java equality language contract。** 本文唯一维护 `==`、`Object.equals`、身份/值/实体相等、五项 equals 契约、hashCode 契约、继承与代理边界、record、可变 equality 和契约测试。Collections 只解释哈希结构如何消费这些规则，见 [Hash 集合如何消费 equals/hashCode 契约](../../02-集合框架/深度解析/Hash集合与equals-hashCode契约.md)。
