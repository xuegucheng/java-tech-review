...
也可直接看 [重载解析图](../03-图示/方法重载/方法重载解析.svg)。图示只表达选择阶段，不替代 JLS 的完整方法调用转换规则。
...
子类新增的 `speak(String)` 不会让父类引用在运行时重新做一次重载匹配。完整动态分派链见 [多态与动态绑定.md](多态与动态绑定.md)，配套示例见 [OverloadResolutionDemo.java](../04-示例代码/src/main/java/com/xuegucheng/javatechreview/core/OverloadResolutionDemo.java)、[OverloadResolutionDemoTest.java](../04-示例代码/src/test/java/com/xuegucheng/javatechreview/core/OverloadResolutionDemoTest.java) 和 [04-示例代码/README.md](../04-示例代码/README.md)。
...
- 可运行验证：见 [04-示例代码/README.md](../04-示例代码/README.md)。
