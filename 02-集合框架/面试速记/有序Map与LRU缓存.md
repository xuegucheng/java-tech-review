...
![LinkedHashMap order model](../../图示/集合框架/LinkedHashMap与LRU.svg)
...
- [LinkedHashMap 与 LRU](../深度解析/LinkedHashMap与LRU缓存.md)
- [HashMap](../深度解析/HashMap原理与源码分析.md)
- [HashSet 与 LinkedHashSet](../深度解析/HashSet与LinkedHashSet.md)

## Runnable Example

- [LinkedHashMapLruDemo.java](../../示例代码/src/main/java/com/xuegucheng/javatechreview/LinkedHashMapLruDemo.java)
- [对应测试](../../示例代码/src/test/java/com/xuegucheng/javatechreview/LinkedHashMapLruDemoTest.java)
