...
> **本章唯一负责 HashMap 的 hash 扰动、桶定位、冲突结构、树化与 resize。** `equals/hashCode` 的语言契约由 [Java Core 对象契约](../../01-Java核心/深度解析/equals与hashCode契约.md)维护；本章只说明 HashMap 在桶内如何消费它。
...
完整运行入口统一见 [示例代码/README.md](../../示例代码/README.md)；本节只保留 HashMap 契约和索引思路的短机制片段。
