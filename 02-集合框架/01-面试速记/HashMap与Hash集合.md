...
![HashMap resize mental model](../03-图示/HashMap/HashMap扩容.svg)
...
- [Hash 集合契约](../02-深度解析/Hash集合与equals-hashCode契约.md)
- [HashSet 与 LinkedHashSet](../02-深度解析/HashSet与LinkedHashSet.md)

## Runnable Example

- [HashMapCollisionDemo.java](../04-示例代码/src/main/java/com/xuegucheng/javatechreview/collections/HashMapCollisionDemo.java)
- [对应测试](../04-示例代码/src/test/java/com/xuegucheng/javatechreview/collections/HashMapCollisionDemoTest.java)
