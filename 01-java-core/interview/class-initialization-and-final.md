...
- [final 与常量](../deep-dive/final-and-constants.md)
- [对象创建与不可变设计](../deep-dive/object-creation-and-immutability.md)

## Runnable Example

- [ClassInitializationDemo.java](../../examples/src/main/java/com/xuegucheng/javatechreview/ClassInitializationDemo.java)
- [对应测试](../../examples/src/test/java/com/xuegucheng/javatechreview/ClassInitializationDemoTest.java)
