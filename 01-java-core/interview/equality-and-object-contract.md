...
本页只维护对象相等性的语言契约。HashMap 如何消费这个契约、HashSet 如何复用 HashMap，见 [Collections 的 Hash 集合复习](../../02-collections/interview/hashmap-and-hash-collections.md)。

## Deep Dive

- [equals 与 hashCode 契约](../deep-dive/equals-and-hashcode-contract.md)
- [Object 方法与工具](../deep-dive/object-methods-and-utilities.md)
