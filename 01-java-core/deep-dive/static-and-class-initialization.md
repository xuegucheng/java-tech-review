...
> **本章是 `static` 与类初始化的唯一权威页。** [类初始化生命周期图](../../diagrams/java/class-initialization.svg)对应本章主线；`final` 常量变量的引用只保留边界，详细语义回到 [final-and-constants.md](final-and-constants.md)。
